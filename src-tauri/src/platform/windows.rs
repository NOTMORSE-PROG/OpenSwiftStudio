...
// Pinned to 6.2.4 (reverted from 6.3.1) per ADR-022: Swift 6.3.1's Foundation.dll
// crashes with STATUS_ILLEGAL_INSTRUCTION (0xC000001D) compiling any code on this
// project's test hardware (a flagship AMD Ryzen 5 9600X — not an old-CPU issue);
// 6.2.4 compiles + runs cleanly. FU-7 tracks compile-verifying 6.3.3 as a forward
// migration before re-pinning ahead.
